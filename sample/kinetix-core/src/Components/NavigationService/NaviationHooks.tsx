...
export type RouterUtilsContextType = {
  readonly navigateRef: React.MutableRefObject<NavigateFunction> | null;
  readonly locationRef: React.MutableRefObject<Location> | null;
  readonly paramsRef: React.MutableRefObject<Readonly<Params<string>>> | null;
};
export const RouterUtilsContext = React.createContext<RouterUtilsContextType>({
  navigateRef: null,
  locationRef: null,
  paramsRef: null,
});
...
interface IRouterUtilsProps {
  children: any;
}

export const RouterUtils: FC<IRouterUtilsProps> = (
  props: IRouterUtilsProps
) => {
...
*/
export const useQueryParamsNoUpdates = (): { [k: string]: string } => {
