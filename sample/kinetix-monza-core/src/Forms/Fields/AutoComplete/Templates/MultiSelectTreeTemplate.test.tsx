...
import { MultiSelectTreeTemplate } from "./MultiSelectTreeTemplate";
...
describe("Kinetix Monza Core", () => {
  ...
  // Testing Component
  describe("MultiSelectTreeTemplate", () => {
    it("should render MultiSelectTreeTemplate", async () => {
      let sut = hostComponent(<MultiSelectTreeTemplate {...props} />);
