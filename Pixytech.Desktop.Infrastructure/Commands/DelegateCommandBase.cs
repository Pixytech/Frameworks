...
{
    /// <summary>
    /// An <see cref="T:System.Windows.Input.ICommand" /> whose delegates can be attached for <see cref="M:Pixytech.Desktop.Presentation.Infrastructure.Commands.DelegateCommandBase.Execute(System.Object)" /> and <see cref="M:Pixytech.Desktop.Presentation.Infrastructure.Commands.DelegateCommandBase.CanExecute(System.Object)" />.
    /// </summary>
    public abstract class DelegateCommandBase : ICommand, IActiveAware
    {
        ...
        /// <summary>
        /// Fired if the <see cref="P:Pixytech.Desktop.Presentation.Infrastructure.Commands.DelegateCommandBase.IsActive" /> property changes.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new instance of a <see cref="T:Pixytech.Desktop.Presentation.Infrastructure.Commands.DelegateCommandBase" />, specifying both the execute action and the can execute function.
        /// </summary>
        ...
        protected DelegateCommandBase(Action<object> executeMethod, Func<object, bool> canExecuteMethod)
        {
            ...
            ExecuteMethod = delegate(object arg)
            {
                executeMethod(arg);
                return Task.Delay(0);
            };
        ...
        /// <summary>
        /// Creates a new instance of a <see cref="T:Pixytech.Desktop.Presentation.Infrastructure.Commands.DelegateCommandBase" />, specifying both the Execute action as an awaitable Task and the CanExecute function.
        /// </summary>
        ...
        /// <summary>
        /// Raises <see cref="E:Pixytech.Desktop.Presentation.Infrastructure.Commands.DelegateCommandBase.CanExecuteChanged" /> on the UI thread so every command invoker
        /// can requery to check if the command can execute.
        /// <remarks>Note that this will trigger the execution of <see cref="M:Pixytech.Desktop.Presentation.Infrastructure.Commands.DelegateCommandBase.CanExecute(System.Object)" /> once for each invoker.</remarks>
        /// </summary>
        ...
        /// <summary>
        /// This raises the <see cref="E:Pixytech.Desktop.Presentation.Infrastructure.Commands.DelegateCommandBase.IsActiveChanged" /> event.
        /// </summary>
