// Angular-specific Ant Design component interfaces
...
export interface AntDesignCardProps extends AntDesignBaseProps {
  title?: string;
  subtitle?: string;
  extra?: string; // Angular template strings
  bordered?: boolean;
  hoverable?: boolean;
}
...
export interface AntDesignTableProps extends AntDesignBaseProps {
  ...
  columns?: Array<{
    ...
    dataIndex: string;
    key: string;
    render?: string; // Angular template strings
  }>;
