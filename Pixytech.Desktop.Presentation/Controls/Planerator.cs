...
namespace Pixytech.Desktop.Presentation.Controls
{
    ...
    public class Planerator : FrameworkElement
    {
        ...
        // Static data
        static private readonly Point3D[] Mesh = { new Point3D(0, 0, 0), new Point3D(0, 1, 0), new Point3D(1, 1, 0), new Point3D(1, 0, 0) };
        static private readonly Point[] TexCoords = { new Point(0, 1), new Point(0, 0), new Point(1, 0), new Point(1, 1) };
        static private readonly int[] Indices = { 0, 2, 1, 0, 3, 2 };
