...
namespace Pixytech.Desktop.Presentation.Controls
{
    ...
    [StyleTypedProperty(Property = "ModernProgressRingStyle", StyleTargetType = typeof(ModernProgressRing))]
    public class ModernBusyIndicator : ContentControl
    {
        ...
        static ModernBusyIndicator()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(ModernBusyIndicator), new FrameworkPropertyMetadata(typeof(ModernBusyIndicator)));
        }

        public ModernBusyIndicator()
        {
        ...
        {
            ((ModernBusyIndicator)d).OnIsBusyChanged(e);
        }
        ...
        #region ModernProgressRing Style

        /// <summary>
        /// Identifies the ProgressBarStyle dependency property.
        /// </summary>
        public static readonly DependencyProperty ModernProgressRingStyleProperty = DependencyProperty.Register(
            "ModernProgressRingStyle",
            typeof(Style),
            typeof(ModernBusyIndicator),
            new PropertyMetadata(null));
        ...
        /// </summary>
        public Style ModernProgressRingStyle
        {
            get
            {
                return (Style)GetValue(ModernProgressRingStyleProperty);
            }
            set
            {
                SetValue(ModernProgressRingStyleProperty, value);
            }
        }
