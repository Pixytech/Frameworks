...
using Pixytech.Desktop.Presentation.Properties;

namespace Pixytech.Desktop.Presentation.DataVisualization
{
    /// <summary>
    ...
    internal class ReadOnlyObservableCollection<T> : NoResetObservableCollection<T>
    {
        ...
        protected override void RemoveItem(int index)
        {
            if (!IsMutating)
            {
                throw new NotSupportedException(Resources.ReadOnlyObservableCollection_CollectionIsReadOnly);
            }
            else
            {
