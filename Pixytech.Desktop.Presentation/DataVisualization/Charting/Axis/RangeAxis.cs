    ...
    public abstract class RangeAxis : DisplayAxis, IRangeAxis, IValueMarginConsumer
    {
        ...
        protected IComparable ProtectedMaximum
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(Wpf.Presentation.Properties.Resources.RangeAxis_MaximumValueMustBeLargerThanOrEqualToMinimumValue);
                }
        ...
        protected IComparable ProtectedMinimum
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(Wpf.Presentation.Properties.Resources.RangeAxis_MinimumValueMustBeLargerThanOrEqualToMaximumValue);
                }
