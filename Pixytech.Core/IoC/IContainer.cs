...
namespace Pixytech.Core.IoC
{
    ...
    public interface IContainer : IDisposable
    {
        ...
        void Configure(Type component, ObjectLifecycle dependencyLifecycle);
        /// <summary>
        ...
        /// <param name="dependencyLifecycle">The desired lifecycle for this type.</param>
        void Configure<T>(Func<T> component, ObjectLifecycle dependencyLifecycle);

        void Configure<T>(Func<T> componentFactory, ObjectLifecycle dependencyLifecycle, bool propertyAutoWired);

        void Configure(Type component, ObjectLifecycle dependencyLifecycle, bool propertyAutoWired);
